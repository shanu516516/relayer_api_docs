...
The Ephemeral Relayer exposes a set of public JSON-RPC endpoints that allow clients to interact with the trading infrastructure. These endpoints support operations such as retrieving market data, querying pool and market state, submitting trading operations, and accessing analytics generated by the relayer.
